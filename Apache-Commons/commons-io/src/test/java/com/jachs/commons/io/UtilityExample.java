...
public final class UtilityExample {
	...
	private static final String EXAMPLE_TXT_PATH = "C:UsersLilykosworkspaceApacheCommonsExampleExampleFolderexampleTxt.txt";

	private static final String PARENT_DIR = "C:UsersLilykosworkspaceApacheCommonsExample";
	private static final String FILE_NAME = "UsersLilykosworkspaceApacheCommonsExample.txt";
	private static final String NASE_NAME = "C:\\AA\\B\\C.txt";
	@Test
	public void runExample() throws IOException {
		...
		System.out.println("Extension of exampleTxt: " + FilenameUtils.getExtension(FILE_NAME));
		System.out.println("Base name of exampleTxt: " + FilenameUtils.getBaseName(NASE_NAME));
