 ...
 *
 */
public class Test2012ExcelReadAllAndFill {
	/****
	 * 读取全量表格数据
	 * @throws Exception
	 */
	...
	public void ReadAll() throws Exception {
		HSSFWorkbook hw=new HSSFWorkbook(Test2012ExcelReadAllAndFill.class.getResourceAsStream("/excel/2012年员工考勤表.xls"));
	...
	public void fillExcel() throws IOException {
		...
		hw.write(new File(Test2012ExcelReadAllAndFill.class.getResource("").getPath()+File.separator+"2012年填充表格.xls"));
	}
