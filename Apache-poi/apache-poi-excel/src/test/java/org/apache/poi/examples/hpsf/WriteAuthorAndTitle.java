...
public final class WriteAuthorAndTitle {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        try (POIFSFileSystem poifs = new POIFSFileSystem();
            ...
            r.registerListener(e -> {
				try {
					handleEvent(poifs, e);
				} catch (MarkUnsupportedException e1) {
					e1.printStackTrace();
				}
			});
     ...
     */
    private static void handleEvent(final POIFSFileSystem poiFs, final POIFSReaderEvent event) throws MarkUnsupportedException {
